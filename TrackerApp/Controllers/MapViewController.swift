...
class MapViewController: UIViewController, CLLocationManagerDelegate {
    ...
    func showLocations() {
        LocationManager.sharedLocationManager().fetchLocations { (status, locations) in
    ...
    func locationManager(_ manager: CLLocationManager, didUpdateLocations locations: [CLLocation]) {
        ...
        self.saveLocation(location: Location.init(latitude: location.coordinate.latitude, longitude: location.coordinate.longitude))
    }
...
//    }
    ...
    func saveLocation(location: Location) {
        LocationManager.sharedLocationManager().saveLocation(location: location)
    }
}
